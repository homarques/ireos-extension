...
public class MaximumMarginClassifierThread extends Thread {
	 ...
	 */
	public MaximumMarginClassifierThread(SVMExamples model, double gammaMax, int outlierIndex, int cl, HashMap<Double, Double> gammaSeparability ) {
		if (model != null)
		...
		this.tol =  gammaMax-(gammaMax*0.999);
